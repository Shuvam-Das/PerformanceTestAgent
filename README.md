...
1. A Jira story or Json file will be there.
2. If the agent is unable to understand the requirement , it should print is issues and why unable to understand or what is the issues.
3. API collection validation
4. If collection is there in the Jira story or Json file ,it will create the K6 script
 if not present then it should print a message that Human Intervention Required
5. If script collections are there and script is ready it must validate the script
6. After validation it should create a workload scenario (mentioned in Jira story or Json file)
7. Check SLA is present or not in the Jira story or in the Json file.
8. If SLA is not present then it should print a message Human intervention required and if present the agent should execute the test, validate the SLA and save the result in a folder.

Note:- Use maximum open source resources with n8n 
